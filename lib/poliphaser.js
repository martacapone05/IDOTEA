...
/**
 * Set the dead zone of the camera. The dead zone is an area where the camera won't follow the target.
 * @function set_deadzone
 * @memberof PP.camera
 * @param {object}      scene   The scene object.
 * @param {number}      width   Width of the dead zone in pixels
 * @param {number}      height  Height of the dead zone in pixels
 */
PP.camera.set_deadzone = function(scene, width, height) {
    PP.debug.assert(typeof scene === "object", "Parameter error: scene should be a scene object.");
    PP.debug.assert(typeof width === "number", "Parameter error: width should be a number.");
    PP.debug.assert(typeof height === "number", "Parameter error: height should be a number.");

    scene.cameras.main.setDeadzone(width, height);
}

/**
 * Set the bounds of the camera. The camera will not scroll beyond these bounds.
 * @function set_bounds
 * @memberof PP.camera
 * @param {object}  scene   The scene object.
 ...
 */
PP.camera.set_bounds = function(scene, x, y, width, height) {
    PP.debug.assert(typeof scene === "object", "Parameter error: scene should be a scene object.");
    PP.debug.assert(typeof x === "number", "Parameter error: x should be a number.");
    PP.debug.assert(typeof y === "number", "Parameter error: y should be a number.");
    PP.debug.assert(typeof width === "number", "Parameter error: width should be a number.");
